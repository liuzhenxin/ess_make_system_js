...
<div class="panel admin-panel">
    ...
    <div class="ub">
        <div class="body-content  f-s-14 c-6">
            <form method="post" class="form-x" action="${pageContext.request.contextPath}/make/make_do.html" id="make_from" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <button type="button" class="button bg-main icon-check-square-o" onclick="sealInfoSubmit1()">提交信息</button>
        ...
        <div class="rightContent ub-f1 ">
            ...
            <div class="ub option">
                <div class="title f-w">签章编码：</div>
                <div class="ub-f1">
                    ${sealApply.certificate.certificateId}
                </div>
            </div>
            <div class="ub option">
            ...
            <div id="pfx_div">
                <div class="ub option">
                    <div class="title f-w">上传证书：</div>
                    <div class="ub-f1" >
                        <div class="uploader white">
                            <input type="text" id="filename" class="filename input " value="证书格式PFX" readonly/>
                            <input type="button" class="button1 " value="上传证书"/>
                            <input type="file" id="pfxFile"/>
                ...
                <div class="ub option">
                    <div class="title f-w">证书密码：</div>
                    <div class="ub-f1">
                        <input type="password" id="cerPsw" name="cerPsw" />
                    </div>
                </div>
            </div>
            <%--<div class="ub option">--%>
            ...
            <%--<div class="ub option">--%>
                ...
                <%--<div class="ub-f1" id="startTime">${sealApply.certificate.startTime}</div>--%>
            <%--</div>--%>
            <%--<div class="ub option">--%>
                <%--<div class="title f-w">有效期结束时间：</div>--%>
                <%--<div class="ub-f1" id="endTime">${sealApply.certificate.endTime}</div>--%>
            <%--</div>--%>
            <%--<c:choose>--%>
                ...
                <%--<c:otherwise>--%>
                    <%--<div class="ub option">--%>
                        <%--<div class="title f-w">有效期起始时间：</div>--%>
                        <%--<div class="ub-f1">--%>
                            <%--<input id="startTime" name="startTime"  type="text" value="${sealApply.certificate.startTime}" readonly/>--%>
                        <%--</div>--%>
                    <%--</div>--%>
                    <%--<div class="ub option">--%>
                        <%--<div class="title f-w">有效期结束时间：</div>--%>
                        <%--<div class="field">--%>
                            <%--<input id="endTime" name="endTime"type="text" value="${sealApply.certificate.endTime}" readonly/>--%>
                        <%--</div>--%>
                    <%--</div>--%>
                <%--</c:otherwise>--%>
            <%--</c:choose>--%>
            <div id="issuer_div" style="display:none">
                <div class="ub option">
...
<script>
    $(function(){
        if("${sealApply.sealTypeId}".indexOf("st7")!==-1){
            //手签
            $("#pfx_div").hide();
            $("#issuer_div").show();
        }
    ...
    function sealInfoSubmit1(){
        ...
        formData.append('pfxBase64', $('#pfxBase64').val());
        formData.append('fileState', $('#fileState').val());
        formData.append('cerPsw', $('#cerPsw').val());
    ...
    function CreateNewCert(sealImgId){
        ...
        //图片ID
        paramter += "&TOKEN="+sealImgId;
        //图片类型
        paramter += "&SEALTYPE="+"gif";
        //授权产品
        paramter += "&PRODUCTS="+GetProductInfoFromAuthNumber("${sealApply.fileTypeNum}");
        //授权到期时间
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data[0].status == 0){
                    ...
                    //更新keyId
                    $.ajax({
                        url: "${pageContext.request.contextPath}/make/updateSealForKeyId.html",
                        type: "post",
                ...
                if(result!="OK"){
                    $.ajax({
                        url: "${pageContext.request.contextPath}/make/sealApplyFail.html",
                        type: "post",
