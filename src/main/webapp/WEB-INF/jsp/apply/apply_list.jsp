...
<form method="post" action="" id="listform">
    <div class="panel admin-panel">
        <div class="panel-head"><strong class="icon-reorder">申请列表</strong> <a href="" style="float:right;">${unit.unitName}</a></div>
        ...
        $('body').dialogbox({
            ...
            buttons:[{
                ...
                callback:function (dialog){
                    $.ajax({
                        url: "${pageContext.request.contextPath}/apply/delete.html",
                        type: "get",
                        data: {"sealApplyId":sealApplyId},
