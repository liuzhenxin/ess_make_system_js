        ...
        <div class="body-content">
            ...
            <ul class="search" >
                ...
                <li class="form-group">
                    ...
                    <div class="field">
                        <input type="text"  class="input w300" id="sealName" name="sealName" value="${sealApply.sealName}" />
                    </div>
                </li>
            </ul>
            ...
            <ul class="search" >
                ...
                <li class="form-group">
                    ...
                    <div class="field">
                        <input type="text"  class="input w300" id="city" name="city"  value="南京市"/>
                    </div>
                </li>
                <li class="form-group">
                    <div class="label">
                ...
                <li class="form-group">
                    ...
                    <div class="field">
                        <input type="text"  class="input w300" id="certDepartment" name="certDepartment" value="${unit.unitName}" />
                    </div>
                </li>
                <li class="form-group">
                    <div class="label">
            ...
            <ul class="search" >
                <li class="form-group">
                    ...
                    <div class="field">
                        ...
                        <%--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--%>
                        <%--<button type="button" class="button bg-main icon-check-square-o w150" onclick="getPfxInfo()" id="getPfxBtn"> 解析证书</button>--%>
                    </div>
                </li>
            </ul>
        </div>
...
<script>
    ...
    function verification(){
        ...
        var fileInput = $('#attachmentFile').get(0).files[0];
        if(!fileInput){
            return "请选择上传文件！";
        }
