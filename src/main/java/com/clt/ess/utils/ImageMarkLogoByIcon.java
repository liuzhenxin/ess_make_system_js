...
public class ImageMarkLogoByIcon {
    ...
    public static void main(String[] args) {
        String output = "E:/temp/";
        String source = "E:/temp/demo.gif";  //源图片路径
        String icon = "E:/temp/demo.jpg"; //覆盖图片路径
        String imageName = "mark_image"; //图片名称
        String imageType = "gif"; //图片类型jpg,jpeg,png,gif
        String text = "————————————";
        int size = 40;  //马赛克大小
        Integer degree = null; //水印旋转角度-45，null表示不旋转
        String result = null;
        //给图片添加图片水印
//        result = ImageMarkLogoByIcon.markImageByMoreIcon(icon,source,output,imageName,imageType,degree);
//        result = ImageMarkLogoByIcon.markImageBySingleIcon(icon, source, output, imageName, imageType, degree);
//    //给图片添加文字水印
//    result = ImageMarkLogoByIcon.markImageByMoreText(source,output,imageName,imageType,Color.red,text,degree);
    result = ImageMarkLogoByIcon.markImageBySingleText(source,output,imageName,imageType,Color.red,text,degree);
//    //给图片打马赛克
