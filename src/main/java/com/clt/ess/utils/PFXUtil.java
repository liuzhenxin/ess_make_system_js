...
//        String privateKeyStr = ESSGetBase64Encode(privateKeyByte);
//        System.out.println("私钥Base64字符串：" + privateKeyStr);
//        //=====私钥Base64字符串转私钥对象
//        PrivateKey privateKey2 = getPrivateKey(privateKeyStr);
//        System.out.println("私钥Base64字符串2：" + ESSGetBase64Encode(privateKey2.getEncoded()));
//        //证书：从pfx文件中获取证书对象
//        X509Certificate certificate = getX509Certificate(pfxPath, password);
//        System.out.println("证书主题：" + certificate.getSubjectDN().getName());
//        String publicKeyStr = ESSGetBase64Encode(certificate.getPublicKey().getEncoded());
//        System.out.println("公钥Base64字符串：" + publicKeyStr);
//        //=====根据公钥Base64字符串获取公钥对象
//        System.out.println("公钥Base64字符串2：" + ESSGetBase64Encode(getPublicKey(publicKeyStr).getEncoded()));
//        //PFX：合成pfx（需要私钥、公钥证书）
//        String savePath = generatorPFX(privateKey, certificate, "1", new File
//                ("C:\\Users\\49383\\Desktop\\文件\\009\\009.pfx"));
//        System.out.println(savePath);
        //测试 导出cer 证书
        String pfxPath1 = "E:\\temp\\江苏省烟草公司电子印章平台.pfx";
        //证书：从pfx文件中获取证书对象
        X509Certificate certificate1 = getX509Certificate(pfxPath1, "111111");
        byte2File(certificate1.getEncoded(),"E:\\temp","test1.cer");
